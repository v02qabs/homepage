...
class BreakoutGame:
    def __init__(self, root):
        ...
        # ボールの初期速度 (数値を小さくして速度を落としました)
        self.ball_dx = random.choice([-2, -1.2, 1.2, 2])
        self.ball_dy = -2.5
    ...
    def update(self):
        ...
        if (paddle_coords[1] <= ball_coords[3] <= paddle_coords[1] + 8 and 
            ...
            # 割る数を 10 から 20 に増やし、横方向の急激な加速を抑えました
            self.ball_dx = (ball_center - paddle_center) / 20  
